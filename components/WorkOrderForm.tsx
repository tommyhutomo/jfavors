...
/**
 * WorkOrder = an "event" you will generate an invoice for.
...
export default function WorkOrderForm({ woId }: { woId?: string }) {
  // SECTION 1 — Search
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-50 p-6">
      <div className="max-w-6xl mx-auto">
        <header className="mb-8">
          <h1 className="text-4xl font-bold text-slate-800 mb-1">Work Order</h1>
